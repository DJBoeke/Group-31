...
from schnapsen.bots import RandBot, AlphaBetaBot, RdeepBot, BullyBot, MyBot
...
@click.command()
@click.option('--bot', '-b',
              type=click.Choice(['AlphaBetaBot', 'RdeepBot', 'MLDataBot', 'MLPlayingBot', 'RandBot', 'BullyBot', 'MyBot'], case_sensitive=False),
